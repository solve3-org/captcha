...
class Modal extends events_1.default {
    constructor() {
        ...
        this.instructionContainer = () => {
            ...
            Object.assign(instruction.style, styles.brandNameFirstLine, styles.fontDark, styles.flexCenter);
        ...
        this.brandContainer = () => {
            ...
            Object.assign(brandContainerDiv.style, styles.flexCenter, styles.padding5, styles.actionContainerStyle);
        ...
        this.setupDragAndDrop = (emitter, scalingFactor, imgElement, captcha) => {
        ...
        this.menu = () => {
            ...
            Object.assign(square1.style, styles.square, styles.flexCenter, styles.fontDark, styles.pointer);
            square1.id = id("onRefresh");
            square1.innerHTML = refreshSvg;
            // square1.addEventListener("click", onRefreshHandler);
            const square2 = document.createElement("div");
            Object.assign(square2.style, styles.square, styles.flexCenter, styles.fontDark, styles.pointer);
            ...
            Object.assign(square3.style, styles.square, styles.flexCenter, styles.fontDark, styles.pointer);
